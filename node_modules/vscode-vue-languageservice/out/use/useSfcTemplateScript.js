...
function useSfcTemplateScript(getUnreactiveDoc, template, templateScriptData, styleDocuments, styleSourceMaps, templateData, sfcTemplateCompileResult, scriptLang, context) {
    let version = 0;
    ...
    const templateCodeGens = reactivity_1.computed(() => {
        ...
        if (!((_a = sfcTemplateCompileResult.value) === null || _a === void 0 ? void 0 : _a.ast))
            return;
        return templateGen.generate(templateData.value.sourceLang, sfcTemplateCompileResult.value.ast, context.isVue2Mode, templateScriptData.components, [...cssScopedClasses.value.values()].map(map => [...map.keys()]).flat(), templateData.value.htmlToTemplate);
    });
    ...
    function update() {
        ...
        if (((_a = data.value) === null || _a === void 0 ? void 0 : _a.getText()) !== ((_b = textDoc.value) === null || _b === void 0 ? void 0 : _b.getText()) || (textDoc.value && textDoc.value.languageId !== shared.syntaxToLanguageId(scriptLang.value))) {
            if (data.value && templateCodeGens.value) {
                ...
                formatTextDoc.value = vscode_languageserver_textdocument_1.TextDocument.create(vueUri + '.__VLS_template.format.' + scriptLang.value, shared.syntaxToLanguageId(scriptLang.value), _version, templateCodeGens.value.formatCodeGen.getText());
