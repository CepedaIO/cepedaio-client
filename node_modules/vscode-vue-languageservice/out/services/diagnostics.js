...
function register({ sourceFiles, getCssLs, jsonLs, templateTsLs, scriptTsLs }, updateTemplateScripts) {
    ...
    function useDiagnostics(sourceFile) {
        const { cssLsDocuments, cssLsSourceMaps, sfcJsons, sfcScriptForScriptLs, lastUpdated, sfcErrors, sfcTemplate, descriptor, document, sfcTemplateScript, sfcTemplateData, sfcTemplateCompileResult, templateScriptData, sfcScriptForTemplateLs, templateLsSourceMaps, } = sourceFile.refs;
